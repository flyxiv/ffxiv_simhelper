...
impl BardDatabase {
    pub(crate) fn new(player_id: IdType, ffxiv_event_queue: Rc<RefCell<FfxivEventQueue>>) -> Self {
        ...
        let WANDERERS_MINUET_RAIDBUFF: BuffStatus = BuffStatus {
            ...
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: StatusInfo::CritHitRatePercent(2),
            duration_millisecond: 45000,
            is_raidwide: true,
            stacks: 1,
            max_stacks: 1,
        ...
        let MAGES_BALLAD_RAIDBUFF: BuffStatus = BuffStatus {
            ...
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: StatusInfo::DamagePercent(1),
            duration_millisecond: 45000,
            is_raidwide: true,
            stacks: 1,
            max_stacks: 1,
        ...
        let ARMYS_PAEON_RAIDBUFF: BuffStatus = BuffStatus {
            ...
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: StatusInfo::DirectHitRatePercent(3),
            duration_millisecond: 45000,
            is_raidwide: true,
            stacks: 1,
            max_stacks: 1,
        ...
        let ARMYS_PAEON_STATUS: BuffStatus = BuffStatus {
            ...
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: StatusInfo::SpeedByStack(vec![4, 8, 12, 16]),
            duration_millisecond: 45000,
            is_raidwide: false,
            stacks: 1,
            max_stacks: 1,
        ...
        let RADIANT_FINALE_STATUS: BuffStatus = BuffStatus {
            ...
            status_info: StatusInfo::DamagePercent(2),
            duration_millisecond: 15000,
            is_raidwide: true,
            stacks: 1,
            max_stacks: 1,
        ...
        let BATTLE_VOICE_STATUS: BuffStatus = BuffStatus {
            ...
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: StatusInfo::DirectHitRatePercent(20),
        ...
        let RAGING_STRIKE_STATUS: BuffStatus = BuffStatus {
            ...
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: StatusInfo::DamagePercent(15),
        ...
        let EMPYREAL_ARROW: AttackSkill = AttackSkill {
            ...
            trait_multiplier: 1.0,
            additional_skill_events: vec![
                FfxivEvent::ForceTicker(TickerKey::new(player_id, 1300), 0),
                FfxivEvent::ForceTicker(TickerKey::new(player_id, 1301), 0),
                FfxivEvent::ForceTicker(TickerKey::new(player_id, 1302), 0),
            ],
            proc_events: vec![],
            combo: None,
            delay_millisecond: None,
