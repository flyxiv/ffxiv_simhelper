...
pub(crate) struct SamuraiDatabase {
    ...
    pub(crate) tsubame_gaeshi_ready: BuffStatus,
...
impl SamuraiDatabase {
    pub(crate) fn new(player_id: IdType) -> Self {
        ...
        let TSUBAME_GAESHI_READY: BuffStatus = BuffStatus {
            id: 1107,
            name: String::from("Tsubame-Gaeshi Ready"),
            stacks: 1,
            max_stacks: 1,
            owner_id: player_id,
            duration_left_millisecond: 0,
