...
pub(crate) struct DarkknightDatabase {
    ...
    pub(crate) blood_weapon: AttackSkill,
    ...
    pub(crate) bloodspiller_delirium: AttackSkill,
...
impl DarkknightDatabase {
    pub(crate) fn new(player_id: IdType) -> Self {
        ...
        let BLOOD_WEAPON: AttackSkill = AttackSkill {
            id: 204,
            name: String::from("Blood Weapon"),
            player_id,
            potency: 0,
            trait_percent: 100,
            additional_skill_events: vec![],
        ...
        let BLOODSPILLER_DELIRIUM: AttackSkill = AttackSkill {
            id: 212,
            name: String::from("Bloodspiller"),
            player_id,
            potency: 500,
        ...
        DarkknightDatabase {
            ...
            bloodspiller_delirium: BLOODSPILLER_DELIRIUM,
...
pub(crate) fn darkknight_gcd_ids() -> Vec<IdType> {
    ...
    vec![
        ...
        db.bloodspiller_delirium.get_id(),
    ]
}
