...
pub(crate) struct AstrologianDatabase {
    ...
    pub(crate) solar_draw: AttackSkill,
    pub(crate) lunar_draw: AttackSkill,
    pub(crate) the_balance: AttackSkill,
    pub(crate) the_spire: AttackSkill,
    pub(crate) divination: AttackSkill,
    pub(crate) lightspeed: AttackSkill,
    pub(crate) minor_arcana: AttackSkill,
...
impl AstrologianDatabase {
    pub(crate) fn new(player_id: IdType) -> Self {
        ...
        let THE_SPIRE_BUFF: BuffStatus = BuffStatus {
            id: 502,
            name: String::from("The Spire"),
            stacks: 1,
            max_stacks: 1,
            owner_id: player_id,
            duration_left_millisecond: 0,
        ...
        let THE_SPIRE_READY: BuffStatus = BuffStatus {
            id: 507,
            name: String::from("The Spire Ready"),
            stacks: 1,
            max_stacks: 1,
            owner_id: player_id,
            duration_left_millisecond: 0,
        ...
        let SOLAR_DRAW: AttackSkill = AttackSkill {
            id: 503,
            name: String::from("Solar Draw"),
            player_id,
            potency: 0,
            trait_percent: 130,
        ...
        let LUNAR_DRAW: AttackSkill = AttackSkill {
            id: 504,
            name: String::from("Lunar Draw"),
            player_id,
            potency: 0,
            trait_percent: 130,
            additional_skill_events: vec![ApplyBuff(
        ...
        let THE_SPIRE: AttackSkill = AttackSkill {
            id: 506,
            name: String::from("The Spire"),
            player_id,
            potency: 0,
            ...
            is_speed_buffed: false,
            cooldown_millisecond: 0,
            resource_required: vec![UseBuff(THE_SPIRE_READY.get_id())],
            resource_created: Default::default(),
            is_guaranteed_crit: false,
            current_cooldown_millisecond: 0,
            stacks: 1,
        ...
        let MINOR_ARCANA: AttackSkill = AttackSkill {
            id: 509,
            name: String::from("Minor Arcana"),
            player_id,
            potency: 0,
            trait_percent: 100,
            additional_skill_events: vec![],
