...
impl RedmageDatabase {
    pub(crate) fn new(player_id: IdType) -> Self {
        ...
        let VERAERO_III: AttackSkill = AttackSkill {
            ...
            proc_events: vec![(verstone_ready_apply, 50)],
            combo: None,
            delay_millisecond: None,
        ...
        let VERAERO_III_ACCEL: AttackSkill = AttackSkill {
            ...
            use_type: UseType::UseOnTarget,
            trait_percent: 130,
            additional_skill_events: vec![verstone_ready_apply],
            proc_events: vec![],
            combo: None,
            delay_millisecond: None,
            casting_time_millisecond: 0,
        ...
        let VERTHUNDER_III_SWIFT: AttackSkill = AttackSkill {
            ...
            trait_percent: 130,
            additional_skill_events: vec![],
            proc_events: vec![(verfire_ready_apply, 50)],
            combo: None,
            delay_millisecond: None,
            casting_time_millisecond: 0,
            gcd_cooldown_millisecond: 2500,
        ...
        let VERTHUNDER_III_ACCEL: AttackSkill = AttackSkill {
            ...
            use_type: UseType::UseOnTarget,
            trait_percent: 130,
            additional_skill_events: vec![verfire_ready_apply],
            proc_events: vec![],
            combo: None,
            delay_millisecond: None,
            casting_time_millisecond: 0,
        ...
        let VERSTONE: AttackSkill = AttackSkill {
            ...
            use_type: UseType::UseOnTarget,
            trait_percent: 130,
            additional_skill_events: vec![dualcast_buff_apply],
            proc_events: vec![],
            combo: None,
            delay_millisecond: None,
