...
pub(crate) struct RedmageDatabase {
    ...
    pub(crate) magicked_swordplay: BuffStatus,
...
impl RedmageDatabase {
    pub(crate) fn new(player_id: IdType) -> Self {
        ...
        let PREFULGENCE_READY: BuffStatus = BuffStatus {
            id: 1809,
            name: String::from("Prefulence Ready"),
            owner_id: player_id,
            duration_left_millisecond: 0,
            status_info: vec![StatusInfo::None],
            duration_millisecond: 30000,
        ...
        let PREFULGENCE: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: false,
            cooldown_millisecond: 0,
            resource_required: vec![UseBuff(PREFULGENCE_READY.get_id())],
            resource_created: Default::default(),
            current_cooldown_millisecond: 0,
            stacks: 1,
            stack_skill_id: None,
