...
const HEALER_START_TIME_MILLISECOND: TimeType = -1550;
...
pub(crate) static WHITEMAGE_START_TIME_MILLISECOND: TimeType = HEALER_START_TIME_MILLISECOND;
pub(crate) static SCHOLAR_START_TIME_MILLISECOND: TimeType = -HEALER_START_TIME_MILLISECOND;
pub(crate) static ASTROLOGIAN_START_TIME_MILLISECOND: TimeType = -10000;
pub(crate) static ASTROLOGIAN_GCD_START_TIME_MILLISECOND: TimeType = HEALER_START_TIME_MILLISECOND;
pub(crate) static SAGE_START_TIME_MILLISECOND: TimeType =
    -HEALER_START_TIME_MILLISECOND - NON_GCD_DELAY_MILLISECOND;
pub(crate) static NINJA_START_TIME_MILLISECOND: TimeType = -1500;
...
pub(crate) static MACHINIST_START_TIME_MILLISECOND: TimeType = -3000;
