...
pub(crate) static WHITEMAGE_START_TIME_MILLISECOND: TimeType = -1000;
pub(crate) static SCHOLAR_START_TIME_MILLISECOND: TimeType = -1000;
pub(crate) static ASTROLOGIAN_START_TIME_MILLISECOND: TimeType = -10000;
pub(crate) static ASTROLOGIAN_GCD_START_TIME_MILLISECOND: TimeType = -1000;
pub(crate) static SAGE_START_TIME_MILLISECOND: TimeType = -1000 - NON_GCD_DELAY_MILLISECOND;
