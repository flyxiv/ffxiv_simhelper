...
use crate::jobs_skill_data::pictomancer::combat_resources::{
    ...
    HAS_CREATURE_ID, HYPERPHANTASIA_STACK_ID, SHOT_MOOGLE_ID, SHOT_STACK_ID, STARRY_SKY_STACK_ID,
};
...
impl PictomancerDatabase {
    pub(crate) fn new(player_id: PlayerIdType) -> Self {
        ...
        let living_muse: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: true,
            cooldown_reduced_by_speed: true,
            resource_required: vec![Resource(HAS_CREATURE_ID, 1)],
            resource_created: HashMap::from([(SHOT_STACK_ID, 1), (CREATURE_STACK_ID, 1)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
        ...
        let mog_of_the_ages: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: true,
            cooldown_reduced_by_speed: true,
            resource_required: vec![Resource(SHOT_STACK_ID, 2)],
            resource_created: HashMap::from([(SHOT_MOOGLE_ID, 1)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
            current_cooldown_millisecond: 0,
        ...
        let pom_motif: AttackSkill = AttackSkill {
            ...
            resource_required: vec![],
            resource_created: HashMap::from([(HAS_CREATURE_ID, 1)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
            current_cooldown_millisecond: 0,
        ...
        let hammer_motif: AttackSkill = AttackSkill {
            ...
            cooldown_reduced_by_speed: false,
            resource_required: vec![],
            resource_created: HashMap::from([(HAMMER_READY_ID, 1)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
            current_cooldown_millisecond: 0,
        ...
        let subtractive_pallete: AttackSkill = AttackSkill {
            ...
            resource_created: HashMap::from([(HARD_GCD_STACK_ID, 3), (BLACK_PAINT_STACK_ID, 1)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
            current_cooldown_millisecond: 0,
        ...
        let striking_muse: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: true,
            cooldown_reduced_by_speed: true,
            resource_required: vec![Resource(HAMMER_READY_ID, 1)],
            resource_created: HashMap::from([(HAMMER_STACK_ID, 3)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
        ...
        let starry_muse: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: false,
            cooldown_reduced_by_speed: false,
            resource_required: vec![Resource(STARRY_SKY_STACK_ID, 1)],
            resource_created: Default::default(),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
        ...
        let hammer_stamp: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: true,
            cooldown_reduced_by_speed: true,
            resource_required: vec![Resource(HAMMER_STACK_ID, 1)],
            resource_created: Default::default(),
        ...
        let comet_in_black: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: true,
            cooldown_reduced_by_speed: true,
            resource_required: vec![Resource(BLACK_PAINT_STACK_ID, 1)],
            resource_created: Default::default(),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
        ...
        let rainbow_drip_proc: AttackSkill = AttackSkill {
            ...
            is_speed_buffed: true,
            cooldown_reduced_by_speed: true,
            resource_required: vec![Resource(HYPERPHANTASIA_STACK_ID, 5)],
            resource_created: Default::default(),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
        ...
        let retribution_of_the_madeem: AttackSkill = AttackSkill {
            ...
            cooldown_reduced_by_speed: false,
            resource_required: vec![
                Resource(SHOT_MOOGLE_ID, 1),
                Resource(SHOT_STACK_ID, 2),
                Resource(CREATURE_STACK_ID, 4),
            ],
            resource_created: Default::default(),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
        ...
        let star_prism: AttackSkill = AttackSkill {
            ...
            resource_created: HashMap::from([(HYPERPHANTASIA_STACK_ID, 1)]),
            is_guaranteed_crit: false,
            is_guaranteed_direct_hit: false,
            cooldown_millisecond: 0,
            current_cooldown_millisecond: 0,
        ...
        let comet_in_black_hyperphantasia: AttackSkill = AttackSkill {
            ...
            cooldown_reduced_by_speed: true,
            resource_required: vec![
                Resource(BLACK_PAINT_STACK_ID, 1),
                UseBuff(hyperphantasia.get_id()),
            ],
            resource_created: HashMap::from([(HYPERPHANTASIA_STACK_ID, 1)]),
            is_guaranteed_crit: false,
