...
impl PaladinDatabase {
    pub(crate) fn new(player_id: PlayerIdType) -> Self {
        ...
        let confiteor: AttackSkill = AttackSkill {
            ...
            cooldown_millisecond: 0,
            resource_required: vec![
                UseBuff(confiteor_ready.get_id()),
                UseBuff(requiescat_buff.get_id()),
            ],
        ...
        let blade_of_faith: AttackSkill = AttackSkill {
            ...
            cooldown_reduced_by_speed: true,
            cooldown_millisecond: 0,
            resource_required: vec![UseBuff(requiescat_buff.get_id()), Resource(1, 1)],
        ...
        let blade_of_truth: AttackSkill = AttackSkill {
            ...
            cooldown_reduced_by_speed: true,
            cooldown_millisecond: 0,
            resource_required: vec![UseBuff(requiescat_buff.get_id()), Resource(2, 1)],
        ...
        let blade_of_valor: AttackSkill = AttackSkill {
            ...
            cooldown_reduced_by_speed: true,
            cooldown_millisecond: 0,
            resource_required: vec![UseBuff(requiescat_buff.get_id()), Resource(3, 1)],
