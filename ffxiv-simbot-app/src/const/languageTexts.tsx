...
export const PLD_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? PLD_EN_NAME : PLD_KR_NAME;
export const WAR_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? WAR_EN_NAME : WAR_KR_NAME;
export const DRK_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DRK_EN_NAME : DRK_KR_NAME;
export const GNB_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? GNB_EN_NAME : GNB_KR_NAME;

export const WHM_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? WHM_EN_NAME : WHM_KR_NAME;
export const SCH_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SCH_EN_NAME : SCH_KR_NAME;
export const AST_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? AST_EN_NAME : AST_KR_NAME;
export const SGE_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SGE_EN_NAME : SGE_KR_NAME;

export const DRG_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DRG_EN_NAME : DRG_KR_NAME;
export const MNK_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? MNK_EN_NAME : MNK_KR_NAME;
export const NIN_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? NIN_EN_NAME : NIN_KR_NAME;
export const SAM_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SAM_EN_NAME : SAM_KR_NAME;
export const RPR_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? RPR_EN_NAME : RPR_KR_NAME;
export const VPR_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? VPR_EN_NAME : VPR_KR_NAME;

export const BRD_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? BRD_EN_NAME : BRD_KR_NAME;
export const MCH_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? MCH_EN_NAME : MCH_KR_NAME;
export const DNC_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DNC_EN_NAME : DNC_KR_NAME;

export const BLM_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? BLM_EN_NAME : BLM_KR_NAME;
export const SMN_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SMN_EN_NAME : SMN_KR_NAME;
export const RDM_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? RDM_EN_NAME : RDM_KR_NAME;
export const PCT_JOB_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? PCT_EN_NAME : PCT_KR_NAME;
...
export function convertToJobText(jobAbbrev: string) {
    return AppConfigurations.languageMode === ENGLISH_MODE ? jobAbbrev : convertToKoreanJobAbbrev(jobAbbrev);
}

// Menu Text
export const NAVIGATE_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Navigate" : "빠른 이동";
export const SAVED_GEARSETS_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Saved Gearsets" : "저장된 장비셋";
export const LOADOUT_NAME_LABEL_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Name" : "이름";
export const LOADOUT_WRITE_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Write" : "저장";
export const LOADOUT_LOAD_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Load" : "로드";
export const DEFAULT_LOADOUT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Default Loadout" : "기본 장비셋";
export const LOAD_COMPLETE_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Load Complete" : "불러오기 완료";
...
export const JOB_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? JOB_EN_TEXT : JOB_KR_TEXT;
export const RACE_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? RACE_EN_TEXT : RACE_KR_TEXT;
export const WEAPON_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? WEAPON_SLOT_EN_TEXT : WEAPON_SLOT_KR_TEXT;
export const OFFHAND_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? OFFHAND_SLOT_EN_TEXT : OFFHAND_SLOT_KR_TEXT;
export const HEAD_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? HEAD_SLOT_EN_TEXT : HEAD_SLOT_KR_TEXT;
export const BODY_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? BODY_SLOT_EN_TEXT : BODY_SLOT_KR_TEXT;
export const HANDS_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? HANDS_SLOT_EN_TEXT : HANDS_SLOT_KR_TEXT;
export const LEGS_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? LEGS_SLOT_EN_TEXT : LEGS_SLOT_KR_TEXT;
export const FEET_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? FEET_SLOT_EN_TEXT : FEET_SLOT_KR_TEXT;
export const EARS_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? EARS_SLOT_EN_TEXT : EARS_SLOT_KR_TEXT;
export const NECK_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? NECK_SLOT_EN_TEXT : NECK_SLOT_KR_TEXT;
export const WRIST_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? WRIST_SLOT_EN_TEXT : WRIST_SLOT_KR_TEXT;
export const FINGER1_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? FINGER1_SLOT_EN_TEXT : FINGER1_SLOT_KR_TEXT;
export const FINGER2_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? FINGER2_SLOT_EN_TEXT : FINGER2_SLOT_KR_TEXT;
export const FOOD_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? FOOD_SLOT_EN_TEXT : FOOD_SLOT_KR_TEXT;
export const AST_MELEE_PARTNER_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? AST_MELEE_PARTNER_EN_TEXT : AST_MELEE_PARTNER_KR_TEXT;
export const AST_RANGED_PARTNER_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? AST_RANGED_PARTNER_EN_TEXT : AST_RANGED_PARTNER_KR_TEXT;
export const DNC_PARTNER_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? DNC_PARTNER_EN_TEXT : DNC_PARTNER_KR_TEXT;
export const FINGER_SLOT_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? FINGER_SLOT_EN_TEXT : FINGER_SLOT_KR_TEXT;
...
export function convertToSlotText(slotName: string) {
    return AppConfigurations.languageMode === ENGLISH_MODE ? slotName : convertToKoreanSlotName(slotName);
}
...
export const MIDLANDER_HYUR_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? MIDLANDER_HYUR_NAME_EN : MIDLANDER_HYUR_NAME_KR;
export const HIGHLANDER_HYUR_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? HIGHLANDER_HYUR_NAME_EN : HIGHLANDER_HYUR_NAME_KR;
export const WILDWOOD_ELEZEN_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? WILDWOOD_ELEZEN_NAME_EN : WILDWOOD_ELEZEN_NAME_KR;
export const DUSKWIGHT_ELEZEN_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DUSKWIGHT_ELEZEN_NAME_EN : DUSKWIGHT_ELEZEN_NAME_KR;
export const PLAINSFOLK_LALAFELL_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? PLAINSFOLK_LALAFELL_NAME_EN : PLAINSFOLK_LALAFELL_NAME_KR;
export const DUNESFOLK_LALAFELL_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DUNESFOLK_LALAFELL_NAME_EN : DUNESFOLK_LALAFELL_NAME_KR;
export const SEEKER_OF_THE_SUN_MIQOTE_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SEEKER_OF_THE_SUN_MIQOTE_NAME_EN : SEEKER_OF_THE_SUN_MIQOTE_NAME_KR;
export const KEEPER_OF_THE_MOON_MIQOTE_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? KEEPER_OF_THE_MOON_MIQOTE_NAME_EN : KEEPER_OF_THE_MOON_MIQOTE_NAME_KR;
export const SEA_WOLVES_ROEGADYN_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SEA_WOLVES_ROEGADYN_NAME_EN : SEA_WOLVES_ROEGADYN_NAME_KR;
export const HELLSGUARD_ROEGADYN_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? HELLSGUARD_ROEGADYN_NAME_EN : HELLSGUARD_ROEGADYN_NAME_KR;
export const RAEN_AU_RA_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? RAEN_AU_RA_NAME_EN : RAEN_AU_RA_NAME_KR;
export const XAELA_AU_RA_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? XAELA_AU_RA_NAME_EN : XAELA_AU_RA_NAME_KR;
export const HELIONS_HROTHGAR_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? HELIONS_HROTHGAR_NAME_EN : HELIONS_HROTHGAR_NAME_KR;
export const THE_LOST_HROTHGAR_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? THE_LOST_HROTHGAR_NAME_EN : THE_LOST_HROTHGAR_NAME_KR;
export const RAVA_VIERA_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? RAVA_VIERA_NAME_EN : RAVA_VIERA_NAME_KR;
export const VEENA_VIERA_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? VEENA_VIERA_NAME_EN : VEENA_VIERA_NAME_KR;
...
export function convertToRaceText(raceName: string) {
    return AppConfigurations.languageMode === ENGLISH_MODE ? raceName : convertToKoreanRaceName(raceName);
}
...
export const CAST_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Cast" : "스윙 수";
...
export const DPS_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "DPS" : "딜러";
...
export const EMPTY_TEXT = AppConfigurations.languageMode === ENGLISH_MODE ? "Empty" : "없음";
...
export const CRIT_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? CRIT_STAT_EN_NAME : CRIT_STAT_KR_NAME;
export const DH_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DH_STAT_EN_NAME : DH_STAT_KR_NAME;
export const DET_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? DET_STAT_EN_NAME : DET_STAT_KR_NAME;
export const SKS_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SKS_STAT_EN_NAME : SKS_STAT_KR_NAME;
export const SPS_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? SPS_STAT_EN_NAME : SPS_STAT_KR_NAME;
export const TEN_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? TEN_STAT_EN_NAME : TEN_STAT_KR_NAME;
export const PIE_STAT_NAME = AppConfigurations.languageMode === ENGLISH_MODE ? PIE_STAT_EN_NAME : PIE_STAT_KR_NAME;
