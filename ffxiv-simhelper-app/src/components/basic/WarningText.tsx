...
export function WarningText(text: string) {
    ...
    return (
        <Link href={language === LanguageMode.KOREAN_MODE ? "https://junyeopn.github.io/blog/docs/ffxivsimhelper/ffxivsimhelperkr" : "https://junyeopn.github.io/blog/docs/ffxivsimhelper/ffxivsimhelperen/"}>
            <Typography
