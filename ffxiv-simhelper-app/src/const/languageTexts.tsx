...
export const AppLanguageTexts: () => TextDictionary = () => {
	...
	const PARTY_COMPOSITION_TEXT = language === LanguageMode.ENGLISH_MODE ? "Party Composition" : "파티 조합";
	const TOTAL_RDPS_TEXT = language === LanguageMode.ENGLISH_MODE ? "Median RDPS" : "RDPS 중위값";
