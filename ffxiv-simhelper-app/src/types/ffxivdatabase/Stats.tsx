...
export const SubstatNames = [CRIT_STAT_NAME, DET_STAT_NAME, DH_STAT_NAME, SKS_STAT_NAME, SPS_STAT_NAME, TEN_STAT_NAME, GCD_NAME];
...
export function getStatNames(jobAbbrev: string) {
  switch (jobAbbrev) {
    ...
    case DRK_EN_NAME:
    case GNB_EN_NAME:
      return [WD_STAT_NAME, STR_STAT_NAME, CRIT_STAT_NAME, DH_STAT_NAME, DET_STAT_NAME, SKS_STAT_NAME, TEN_STAT_NAME, GCD_NAME];
    case WHM_EN_NAME:
    case SCH_EN_NAME:
    case AST_EN_NAME:
    case SGE_EN_NAME:
      return [WD_STAT_NAME, MIND_STAT_NAME, CRIT_STAT_NAME, DH_STAT_NAME, DET_STAT_NAME, SPS_STAT_NAME, GCD_NAME];
    case DRG_EN_NAME:
    case MNK_EN_NAME:
    case SAM_EN_NAME:
    case RPR_EN_NAME:
      return [WD_STAT_NAME, STR_STAT_NAME, CRIT_STAT_NAME, DH_STAT_NAME, DET_STAT_NAME, SKS_STAT_NAME, GCD_NAME];
    case NIN_EN_NAME:
    case VPR_EN_NAME:
    case BRD_EN_NAME:
    case MCH_EN_NAME:
    case DNC_EN_NAME:
      return [WD_STAT_NAME, DEX_STAT_NAME, CRIT_STAT_NAME, DH_STAT_NAME, DET_STAT_NAME, SKS_STAT_NAME, GCD_NAME]
    case BLM_EN_NAME:
    case SMN_EN_NAME:
    case RDM_EN_NAME:
    case PCT_EN_NAME:
      return [WD_STAT_NAME, INT_STAT_NAME, CRIT_STAT_NAME, DH_STAT_NAME, DET_STAT_NAME, SPS_STAT_NAME, GCD_NAME]
    default:
      return [];
  }
}
